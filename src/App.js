...
function App() {
  let data = [
      {
        bodyPart: "back",
        equipment: "cable",
        gifUrl: "https://v2.exercisedb.io/image/u68fV5DT-NfPGo",
        id: "0007",
      ...
      },
      {
        ...
        gifUrl: "https://v2.exercisedb.io/image/764LMA6hapm4w7",
        id: "3293",
        name: "archer pull up",
        target: "lats",
      ...
      },
      {
        ...
        gifUrl: "https://v2.exercisedb.io/image/-OlJz8cOhEyULd",
        id: "0015",
      ...
      },
      {
        bodyPart: "back",
        equipment: "leverage machine",
        gifUrl: "https://v2.exercisedb.io/image/BXQ44JqnMIfZ7g",
        id: "0017",
      ...
      },
      {
        bodyPart: "back",
        equipment: "leverage machine",
        gifUrl: "https://v2.exercisedb.io/image/5AOY9Znld4cO23",
        id: "1431",
      ...
      },
      {
        bodyPart: "back",
        equipment: "leverage machine",
        gifUrl: "https://v2.exercisedb.io/image/A4CAeW-EMaZ2WD",
        id: "1432",
      ...
      },
      {
        ...
        gifUrl: "https://v2.exercisedb.io/image/R79ZGphl30KL1t",
        id: "1314",
      ...
      },
      {
        bodyPart: "back",
        equipment: "body weight",
        gifUrl: "https://v2.exercisedb.io/image/QGuOdc5gUqvQAX",
        id: "3297",
        name: "back lever",
        target: "upper back",
      ...
      },
      {
        bodyPart: "back",
        equipment: "body weight",
        gifUrl: "https://v2.exercisedb.io/image/Id9SxqvMcd5YCm",
        id: "1405",
      ...
      },
      {
        bodyPart: "back",
        equipment: "band",
        gifUrl: "https://v2.exercisedb.io/image/7SrUvjighfkYC7",
        id: "0970",
    ...
    let [bodypartName, setbodypartName]=useState("biceps");
    let [inputValue, setInputValue]= useState("");
  useEffect(() => {
    console.log(bodypartName);
    const options = {
      method: "GET",
      url: `https://exercisedb.p.rapidapi.com/exercises/name/${bodypartName}`,
      params: { limit: "10" },
      headers: {
  ...
  return <div className="App">
    ...
    <input type="text" onChange={getInput} value={inputValue} placeholder="Enter Bodypart Name"/>
  </div>;
}
